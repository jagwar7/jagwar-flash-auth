...
// IT WILL BE CALLED WHEN FORM OPENS TO SUBMIT AND WILL BE FETCHED AND FORM DATA WILL BE PO
router.get('/get', AuthProviderSwitcher, async(req, res)=>{
    try {
        ...
        creds.clientPublicKey = Decrypt(creds.clientPublicKey);
        ...
        creds.tokenExpiryDuration = Decrypt(creds.tokenExpiryDuration);
